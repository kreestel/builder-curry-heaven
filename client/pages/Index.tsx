  ...
  return (
    <div className="min-h-screen bg-[#FFF3DA] overflow-x-hidden">
      ...
      {/* Footer */}
              ...
              {/* Instagram Redirect */}
              <a
                href="https://www.instagram.com/oranza._.fest" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 lg:w-14 lg:h-14 bg-[#DA4A01] rounded-full flex items-center justify-center hover:scale-110 transition-transform cursor-pointer"
              >
                {/* Instagram Icon SVG */}
                <svg
